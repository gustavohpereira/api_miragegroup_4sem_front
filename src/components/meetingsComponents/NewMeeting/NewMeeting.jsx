  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="w-full">
        <form className="p-4 mt-4 lg:gap-8" onSubmit={(e) => handleSubmit(e, meetingData, setCreatingMeeting, toast)}>
          <div className="grid  grid-cols-1 w-full justify-center  items-center  gap-32">
            ...
            <div className="grid grid-cols-3 grid-rows-2 lg:w-4/6 w-full">
              ...
              <div className="w-full flex flex-col lg:flex-row items-center lg:justify-end self-start mt-8 lg:col-span-1 lg:self-end  col-span-3">
                {!creatingMeeting ? (
                  <button type="submit" className="bg-[#FED353] text-[#FEFEFE] transition ease-in-out hover:bg-[#F6A700] p-2 rounded-md shadow-lg w-[124px] mt-4 lg:mt-0 lg:ml-4">
                    Criar
                  </button>
                ) : (
                  <div role="status" className="p-2 rounded-md bg-[#FED353] flex justify-center shadow-lg w-[124px] mt-4 lg:mt-0 lg:ml-4">
